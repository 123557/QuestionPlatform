...
namespace Yi.Abp.Application.Services
{
    ...
    public class TestService : ApplicationService
    {
        ...
        public ISqlSugarRepository<UserEntity> UsersqlSugarRepository { get; set; }
        /// <summary>
        /// 动态Api
        /// </summary>
        ...
        public async Task<object> GetUserDbAsync()
        {
            //用户体验优先，可直接使用Db操作，依赖抽象
            return await UsersqlSugarRepository._DbQueryable.ToListAsync();
        }
